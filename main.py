...
class Snake(object):
    ...
    def lose(self):
        ...
        back_button = button.Button(pg.image.load(images_path / "back_snake_img2.png"), 6)
        play_again_button = button.Button(pg.image.load(images_path / "play_again_snake_img.png"), 6)
        game_over_snake_label = label.Label(pg.image.load(images_path / "game_over_img.png"), 9.29)
        background_snake_label = label.Label(pg.image.load(images_path / "background_snake_img.png"), 30)
        your_score_label = label.Label(pg.image.load(images_path / "your_score_was_img.png"), 4)
        ...
        while True:
            ...
            for i, number in enumerate(str(self.length)):
                mod.put_number_on_screen(i, int(number), self.length, self.surface, 675, 307)
    ...
    def draw(self, alive, wall=None):
        leftright_dead_square_label = label.Label(pg.image.load(images_path / "leftright_dead_square_img.png"), 1)
        updown_dead_square_label = label.Label(pg.image.load(images_path / "updown_dead_square_img.png"), 1)

        last_left_square_label = label.Label(pg.image.load(images_path / "last_left_square_img.png"), 1)
        last_right_square_label = label.Label(pg.image.load(images_path / "last_right_square_img.png"), 1)
        last_up_square_label = label.Label(pg.image.load(images_path / "last_up_square_img.png"), 1)
        last_down_square_label = label.Label(pg.image.load(images_path / "last_down_square_img.png"), 1)
        
        top_left_square_label = label.Label(pg.image.load(images_path / "top_left_square_img.png"), 1)
        top_right_square_label = label.Label(pg.image.load(images_path / "top_right_square_img.png"), 1)
        bottem_left_square_label = label.Label(pg.image.load(images_path / "bottem_left_square_img.png"), 1)
        bottem_right_square_label = label.Label(pg.image.load(images_path / "bottem_right_square_img.png"), 1)
        leftright_square_label = label.Label(pg.image.load(images_path / "leftright_square_img.png"), 1)
        updown_square_label = label.Label(pg.image.load(images_path / "updown_square_img.png"), 1)
...
class Food(object):
    ...
    def draw_food(self, surface):
        green_square_label = label.Label(pg.image.load(images_path / "green_square_img.png"), 1)
        red_square_label = label.Label(pg.image.load(images_path / "red_square_img.png"), 1)
...
def speed_test(surface, sound_on):
    ...
    # Creating all buttons or labels
    slow_button = button.Button(pg.image.load(images_path / "snail_snake_img.png"), 8)
    medium_button = button.Button(pg.image.load(images_path / "medium_snake_img.png"), 8) 
    fast_button = button.Button(pg.image.load(images_path / "speedy_snake_img.png"), 8) 
    back_button = button.Button(pg.image.load(images_path / "back_snake_img.png"), 6) 
    speed_label = label.Label(pg.image.load(images_path / "speed_img.png"), 14)
...
def main(): 
    ...
    # Creating all buttons or labels
    start_button = button.Button(pg.image.load(images_path / "start_snake_img.png"), 7.8)
    exit_button = button.Button(pg.image.load(images_path / "exit_snake_img.png"), 7.8) 
    rules_button = button.Button(pg.image.load(images_path / "rules_snake_img.png"), 7.8)
    ai_button = button.Button(pg.image.load(images_path / "ai_img.png"), 7.8) 
    title_label = label.Label(pg.image.load(images_path / "snake_title_img.png"), 14)
    sound_on_button = button.Button(pg.image.load(images_path / "sound_on_img.png"), 6.5) 
    sound_off_button = button.Button(pg.image.load(images_path / "sound_off_img.png"), 6.5) 
